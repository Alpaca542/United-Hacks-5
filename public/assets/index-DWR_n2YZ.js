 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ya=new Mf("@firebase/firestore");function Ao(){return ya.logLevel}function ae(i,...e){if(ya.logLevel<=ke.DEBUG){const t=e.map(Yg);ya.debug(`Firestore (${Zo}): ${i}`,...t)}}function vs(i,...e){if(ya.logLevel<=ke.ERROR){const t=e.map(Yg);ya.error(`Firestore (${Zo}): ${i}`,...t)}}function pr(i,...e){if(ya.logLevel<=ke.WARN){const t=e.map(Yg);ya.warn(`Firestore (${Zo}): ${i}`,...t)}}function Yg(i){if(typeof i=="string")return i;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jo(i){if(i.code!==X.FAILED_PRECONDITION||i.message!==yO)throw i;ae("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I0="ConnectivityMonitor";class N0{constructor(){this.Oo=()=>this.No(),this.Bo=()=>this.Lo(),this.ko=[],this.qo()}xo(e){this.ko.push(e)}shutdown(){window.removeEventListener("online",this.Oo),window.removeEventListener("offline",this.Bo)}qo(){window.addEventListener("online",this.Oo),window.addEventListener("offline",this.Bo)}No(){ae(I0,"Network connectivity changed: AVAILABLE");for(const e of this.ko)e(0)}Lo(){ae(I0,"Network connectivity changed: UNAVAILABLE");for(const e of this.ko)e(1)}static C(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rm="RestConnection",aM={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class oM{get Qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),a=encodeURIComponent(this.databaseId.database);this.$o=t+"://"+e.host,this.Uo=`projects/${s}/databases/${a}`,this.Ko=this.databaseId.database===df?`project_id=${s}`:`project_id=${s}&database_id=${a}`}Wo(e,t,s,a,l){const c=lg(),d=this.Go(e,t.toUriEncodedString());ae(Rm,`Sending RPC '${e}' ${c}:`,d,s);const m={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.Ko};this.zo(m,a,l);const{host:g}=new URL(d),E=Tr(g);return this.jo(e,d,m,s,E).then(T=>(ae(Rm,`Received RPC '${e}' ${c}: `,T),T),T=>{throw pr(Rm,`RPC '${e}' ${c} failed with error: `,T,"url: ",d,"request:",s),T})}Jo(e,t,s,a,l,c){return this.Wo(e,t,s,a,l)}zo(e,t,s){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Zo}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((a,l)=>e[l]=a),s&&s.headers.forEach((a,l)=>e[l]=a)}Go(e,t){const s=aM[e];return`${this.$o}/v1/${t}:${s}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const on="WebChannelConnection";class uM extends oM{constructor(e){super(e),this.u_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}jo(e,t,s,a,l){const c=lg();return new Promise((d,m)=>{const g=new zA;g.setWithCredentials(!0),g.listenOnce(BA.COMPLETE,()=>{try{switch(g.getLastErrorCode()){case jh.NO_ERROR:const T=g.getResponseJson();ae(on,`XHR for RPC '${e}' ${c} received:`,JSON.stringify(T)),d(T);break;case jh.TIMEOUT:ae(on,`RPC '${e}' ${c} timed out`),m(new fe(X.DEADLINE_EXCEEDED,"Request time out"));break;case jh.HTTP_ERROR:const w=g.getStatus();if(ae(on,`RPC '${e}' ${c} failed with status:`,w,"response text:",g.getResponseText()),w>0){let x=g.getResponseJson();Array.isArray(x)&&(x=x[0]);const F=x?.error;if(F&&F.status&&F.message){const $=function(oe){const le=oe.toLowerCase().replace(/_/g,"-");return Object.values(X).indexOf(le)>=0?le:X.UNKNOWN}(F.status);m(new fe($,F.message))}else m(new fe(X.UNKNOWN,"Server responded with status "+g.getStatus()))}else m(new fe(X.UNAVAILABLE,"Connection failed."));break;default:Te(9055,{c_:e,streamId:c,l_:g.getLastErrorCode(),h_:g.getLastError()})}}finally{ae(on,`RPC '${e}' ${c} completed.`)}});const E=JSON.stringify(a);ae(on,`RPC '${e}' ${c} sending request:`,a),g.send(t,"POST",E,s,15)})}P_(e,t,s){const a=lg(),l=[this.$o,"/","google.firestore.v1.Firestore","/",e,"/channel"],c=jA(),d=qA(),m={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},g=this.longPollingOptions.timeoutSeconds;g!==void 0&&(m.longPollingTimeout=Math.round(1e3*g)),this.useFetchStreams&&(m.useFetchStreams=!0),this.zo(m.initMessageHeaders,t,s),m.encodeInitMessageHeaders=!0;const E=l.join("");ae(on,`Creating RPC '${e}' stream ${a}: ${E}`,m);const T=c.createWebChannel(E,m);this.T_(T);let w=!1,x=!1;const F=new lM({Ho:H=>{x?ae(on,`Not sending because RPC '${e}' stream ${a} is closed:`,H):(w||(ae(on,`Opening RPC '${e}' stream ${a} transport.`),T.open(),w=!0),ae(on,`RPC '${e}' stream ${a} sending:`,H),T.send(H))},Yo:()=>T.close()}),$=(H,oe,le)=>{H.listen(oe,te=>{try{le(te)}catch(ye){setTimeout(()=>{throw ye},0)}})};return $(T,Eu.EventType.OPEN,()=>{x||(ae(on,`RPC '${e}' stream ${a} transport opened.`),F.s_())}),$(T,Eu.EventType.CLOSE,()=>{x||(x=!0,ae(on,`RPC '${e}' stream ${a} transport closed`),F.__(),this.I_(T))}),$(T,Eu.EventType.ERROR,H=>{x||(x=!0,pr(on,`RPC '${e}' stream ${a} transport errored. Name:`,H.name,"Message:",H.message),F.__(new fe(X.UNAVAILABLE,"The operation could not be completed")))}),$(T,Eu.EventType.MESSAGE,H=>{var oe;if(!x){const le=H.data[0];Ye(!!le,16349);const te=le,ye=te?.error||((oe=te[0])===null||oe===void 0?void 0:oe.error);if(ye){ae(on,`RPC '${e}' stream ${a} received error:`,ye);const se=ye.status;let he=function(C){const M=It[C];if(M!==void 0)return ww(M)}(se),N=ye.message;he===void 0&&(he=X.INTERNAL,N="Unknown error status: "+se+" with message "+ye.message),x=!0,F.__(new fe(he,N)),T.close()}else ae(on,`RPC '${e}' stream ${a} received:`,le),F.a_(le)}}),$(d,FA.STAT_EVENT,H=>{H.stat===Xm.PROXY?ae(on,`RPC '${e}' stream ${a} detected buffering proxy`):H.stat===Xm.NOPROXY&&ae(on,`RPC '${e}' stream ${a} detected no buffering proxy`)}),setTimeout(()=>{F.o_()},0),F}terminate(){this.u_.forEach(e=>e.close()),this.u_=[]}T_(e){this.u_.push(e)}I_(e){this.u_=this.u_.filter(t=>t===e)}}function Cm(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Er="FirestoreClient";class WM{constructor(e,t,s,a,l){this.authCredentials=e,this.appCheckCredentials=t,this.asyncQueue=s,this.databaseInfo=a,this.user=ln.UNAUTHENTICATED,this.clientId=Qg.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=l,this.authCredentials.start(s,async c=>{ae(Er,"Received user=",c.uid),await this.authCredentialListener(c),this.user=c}),this.appCheckCredentials.start(s,c=>(ae(Er,"Received new app check token=",c),this.appCheckCredentialListener(c,this.user)))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}terminate(){this.asyncQueue.enterRestrictedMode();const e=new ur;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(t){const s=p_(t,"Failed to shutdown persistence");e.reject(s)}}),e.promise}}async function Im(i,e){i.asyncQueue.verifyOperationInProgress(),ae(Er,"Initializing OfflineComponentProvider");const t=i.configuration;await e.initialize(t);let s=t.initialUser;i.setCredentialChangeListener(async a=>{s.isEqual(a)||(await xw(e.localStore,a),s=a)}),e.persistence.setDatabaseDeletedListener(()=>{pr("Terminating Firestore due to IndexedDb database deletion"),i.terminate().then(()=>{ae("Terminating Firestore due to IndexedDb database deletion completed successfully")}).catch(a=>{pr("Terminating Firestore due to IndexedDb database deletion failed",a)})}),i._offlineComponents=e}async function L0(i,e){i.asyncQueue.verifyOperationInProgress();const t=await XM(i);ae(Er,"Initializing OnlineComponentProvider"),await e.initialize(t,i.configuration),i.setCredentialChangeListener(s=>O0(e.remoteStore,s)),i.setAppCheckTokenChangeListener((s,a)=>O0(e.remoteStore,a)),i._onlineComponents=e}async function XM(i){if(!i._offlineComponents)if(i._uninitializedComponentsProvider){ae(Er,"Using user provided OfflineComponentProvider");try{await Im(i,i._uninitializedComponentsProvider._offline)}catch(e){const t=e;if(!function(a){return a.name==="FirebaseError"?a.code===X.FAILED_PRECONDITION||a.code===X.UNIMPLEMENTED:!(typeof DOMException<"u"&&a instanceof DOMException)||a.code===22||a.code===20||a.code===11}(t))throw t;pr("Error using user provided cache. Falling back to memory cache: "+t),await Im(i,new Tf)}}else ae(Er,"Using default OfflineComponentProvider"),await Im(i,new QM(void 0));return i._offlineComponents}async function sb(i){return i._onlineComponents||(i._uninitializedComponentsProvider?(ae(Er,"Using user provided OnlineComponentProvider"),await L0(i,i._uninitializedComponentsProvider._online)):(ae(Er,"Using default OnlineComponentProvider"),await L0(i,new hg))),i._onlineComponents}function $M(i){return sb(i).then(e=>e.syncEngine)}async function fg(i){const e=await sb(i),t=e.eventManager;return t.onListen=VM.bind(null,e.syncEngine),t.onUnlisten=UM.bind(null,e.syncEngine),t.onFirstRemoteStoreListen=xM.bind(null,e.syncEngine),t.onLastRemoteStoreUnlisten=zM.bind(null,e.syncEngine),t}function ZM(i,e,t={}){const s=new ur;return i.asyncQueue.enqueueAndForget(async()=>function(l,c,d,m,g){const E=new ib({next:w=>{E.Ou(),c.enqueueAndForget(()=>Yw(l,T));const x=w.docs.has(d);!x&&w.fromCache?g.reject(new fe(X.UNAVAILABLE,"Failed to get document because the client is offline.")):x&&w.fromCache&&m&&m.source==="server"?g.reject(new fe(X.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):g.resolve(w)},error:w=>g.reject(w)}),T=new Qw(jf(d.path),E,{includeMetadataChanges:!0,ka:!0});return Kw(l,T)}(await fg(i),i.asyncQueue,e,t,s)),s.promise}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
