...
`)};function Ti(h){h.onreadystatechange&&h.onreadystatechange.call(h)}Object.defineProperty(Zi.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(h){this.m=h?"include":"same-origin"}});function wl(h){let _="";return oe(h,function(y,A){_+=A,_+=":",_+=y,_+=`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ee(i,e,t){let s="Unexpected state";typeof e=="string"?s=e:t=e,_w(i,s,t)}function _w(i,e,t){let s=`FIRESTORE (${nl}) INTERNAL ASSERTION FAILED: ${e} (ID: ${i.toString(16)})`;if(t!==void 0)try{s+=" CONTEXT: "+JSON.stringify(t)}catch{s+=" CONTEXT: "+t}throw As(s),new Error(s)}function We(i,e,t,s){let a="Unexpected state";typeof t=="string"?a=t:s=t,i||_w(e,a,s)}function we(i,e){return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function il(i){if(i.code!==Q.FAILED_PRECONDITION||i.message!==HO)throw i;ae("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const on="WebChannelConnection";class kM extends OM{constructor(e){super(e),this.u_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}jo(e,t,s,a,l){const c=wg();return new Promise((d,m)=>{const g=new fw;g.setWithCredentials(!0),g.listenOnce(dw.COMPLETE,()=>{try{switch(g.getLastErrorCode()){case Zh.NO_ERROR:const T=g.getResponseJson();ae(on,`XHR for RPC '${e}' ${c} received:`,JSON.stringify(T)),d(T);break;case Zh.TIMEOUT:ae(on,`RPC '${e}' ${c} timed out`),m(new re(Q.DEADLINE_EXCEEDED,"Request time out"));break;case Zh.HTTP_ERROR:const w=g.getStatus();if(ae(on,`RPC '${e}' ${c} failed with status:`,w,"response text:",g.getResponseText()),w>0){let P=g.getResponseJson();Array.isArray(P)&&(P=P[0]);const B=P?.error;if(B&&B.status&&B.message){const Z=function(me){const he=me.toLowerCase().replace(/_/g,"-");return Object.values(Q).indexOf(he)>=0?he:Q.UNKNOWN}(B.status);m(new re(Z,B.message))}else m(new re(Q.UNKNOWN,"Server responded with status "+g.getStatus()))}else m(new re(Q.UNAVAILABLE,"Connection failed."));break;default:Ee(9055,{c_:e,streamId:c,l_:g.getLastErrorCode(),h_:g.getLastError()})}}finally{ae(on,`RPC '${e}' ${c} completed.`)}});const v=JSON.stringify(a);ae(on,`RPC '${e}' ${c} sending request:`,a),g.send(t,"POST",v,s,15)})}P_(e,t,s){const a=wg(),l=[this.$o,"/","google.firestore.v1.Firestore","/",e,"/channel"],c=gw(),d=mw(),m={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},g=this.longPollingOptions.timeoutSeconds;g!==void 0&&(m.longPollingTimeout=Math.round(1e3*g)),this.useFetchStreams&&(m.useFetchStreams=!0),this.zo(m.initMessageHeaders,t,s),m.encodeInitMessageHeaders=!0;const v=l.join("");ae(on,`Creating RPC '${e}' stream ${a}: ${v}`,m);const T=c.createWebChannel(v,m);this.T_(T);let w=!1,P=!1;const B=new MM({Ho:K=>{P?ae(on,`Not sending because RPC '${e}' stream ${a} is closed:`,K):(w||(ae(on,`Opening RPC '${e}' stream ${a} transport.`),T.open(),w=!0),ae(on,`RPC '${e}' stream ${a} sending:`,K),T.send(K))},Yo:()=>T.close()}),Z=(K,me,he)=>{K.listen(me,ce=>{try{he(ce)}catch(be){setTimeout(()=>{throw be},0)}})};return Z(T,bu.EventType.OPEN,()=>{P||(ae(on,`RPC '${e}' stream ${a} transport opened.`),B.s_())}),Z(T,bu.EventType.CLOSE,()=>{P||(P=!0,ae(on,`RPC '${e}' stream ${a} transport closed`),B.__(),this.I_(T))}),Z(T,bu.EventType.ERROR,K=>{P||(P=!0,yr(on,`RPC '${e}' stream ${a} transport errored. Name:`,K.name,"Message:",K.message),B.__(new re(Q.UNAVAILABLE,"The operation could not be completed")))}),Z(T,bu.EventType.MESSAGE,K=>{var me;if(!P){const he=K.data[0];We(!!he,16349);const ce=he,be=ce?.error||((me=ce[0])===null||me===void 0?void 0:me.error);if(be){ae(on,`RPC '${e}' stream ${a} received error:`,be);const le=be.status;let oe=function(I){const M=Dt[I];if(M!==void 0)return Zw(M)}(le),O=be.message;oe===void 0&&(oe=Q.INTERNAL,O="Unknown error status: "+le+" with message "+be.message),P=!0,B.__(new re(oe,O)),T.close()}else ae(on,`RPC '${e}' stream ${a} received:`,he),B.a_(he)}}),Z(d,pw.STAT_EVENT,K=>{K.stat===hg.PROXY?ae(on,`RPC '${e}' stream ${a} detected buffering proxy`):K.stat===hg.NOPROXY&&ae(on,`RPC '${e}' stream ${a} detected no buffering proxy`)}),setTimeout(()=>{B.o_()},0),B}terminate(){this.u_.forEach(e=>e.close()),this.u_=[]}T_(e){this.u_.push(e)}I_(e){this.u_=this.u_.filter(t=>t===e)}}function qm(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const vV=5*60,EV=HS("authIdTokenMaxAge")||vV;let VS=null;const TV=i=>async e=>{const t=e&&await e.getIdTokenResult(),s=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(s&&s>EV)return;const a=t?.token;VS!==a&&(VS=a,await fetch(i,{method:a?"POST":"DELETE",headers:a?{Authorization:`Bearer ${a}`}:{}}))};function SV(i=Qf()){const e=Ju(i,"auth");if(e.isInitialized())return e.getImmediate();const t=Gx(i,{popupRedirectResolver:mV,persistence:[RP,pP,_R]}),s=HS("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const l=new URL(s,location.origin);if(location.origin===l.origin){const c=TV(l.toString());cP(t,c,()=>c(t.currentUser)),uP(t,d=>c(d))}}const a=FS("auth");return a&&Yx(t,`http://${a}`),t}function AV(){var i,e;return(e=(i=document.getElementsByTagName("head"))===null||i===void 0?void 0:i[0])!==null&&e!==void 0?e:document}Lx({loadJS(i){return new Promise((e,t)=>{const s=document.createElement("script");s.setAttribute("src",i),s.onload=e,s.onerror=a=>{const l=Ui("internal-error");l.customData=a,t(l)},s.type="text/javascript",s.charset="UTF-8",AV().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});yV("Browser");const wV={apiKey:"AIzaSyD-EnuWkZgnjb6hnaP4LhUIZvxSCf5tiIo",authDomain:"game-of-trust-675c9.firebaseapp.com",projectId:"game-of-trust-675c9",storageBucket:"game-of-trust-675c9.firebasestorage.app",messagingSenderId:"72708199445",appId:"1:72708199445:web:ce23ac49a6c15fe7f02a1c",measurementId:"G-K3GSYXR89X"},Sd=XS(wV);CO(Sd);const sr=Rk(Sd),$u=SV(Sd),gc=ux(Sd,"us-central1");qb(gc,"localhost",5001);const bV=({onAuthSuccess:i})=>{const[e,t]=it.useState(!0),[s,a]=it.useState(""),[l,c]=it.useState(""),[d,m]=it.useState(""),[g,v]=it.useState(!1),[T,w]=it.useState(""),P=async B=>{B.preventDefault(),v(!0),w("");try{if(e){const Z=await lP($u,s,l);i(Z.user.uid)}else{if(!d.trim()){w("Username is required for registration");return}const Z=await oP($u,s,l);await Fk(pa(sr,"usernames",Z.user.uid),{username:d.trim(),createdAt:new Date().toISOString()}),i(Z.user.uid)}}catch(Z){w(Z.message||"An error occurred")}finally{v(!1)}};return X.jsxs("div",{children:[X.jsx("h2",{children:e?"Login":"Sign Up"}),X.jsxs("form",{onSubmit:P,children:[X.jsxs("div",{children:[X.jsx("label",{children:"Email:"}),X.jsx("input",{type:"email",value:s,onChange:B=>a(B.target.value),required:!0})]}),X.jsxs("div",{children:[X.jsx("label",{children:"Password:"}),X.jsx("input",{type:"password",value:l,onChange:B=>c(B.target.value),required:!0})]}),!e&&X.jsxs("div",{children:[X.jsx("label",{children:"Username:"}),X.jsx("input",{type:"text",value:d,onChange:B=>m(B.target.value),required:!0})]}),T&&X.jsx("div",{style:{color:"red"},children:T}),X.jsx("button",{type:"submit",disabled:g,children:g?"Loading...":e?"Login":"Sign Up"})]}),X.jsxs("button",{onClick:()=>t(!e),children:["Switch to ",e?"Sign Up":"Login"]})]})},Ff=async i=>{try{const e=await jk(pa(sr,"usernames",i));return e.exists()?e.data().username:null}catch(e){return console.error("Error fetching username:",e),null}},Co=6,LS=({game:i,currentUser:e,onCellClick:t,onAnimationComplete:s,gridSize:a=50})=>{const[l,c]=it.useState(null),[d,m]=it.useState(0),[g,v]=it.useState(!1);var T=!1;window.addEventListener("mousedown",()=>T=!0),window.addEventListener("mouseup",()=>T=!1);const w=le=>{const oe={};for(let O=0;O<a;O++){oe[`row${O}`]=[];for(let b=0;b<a;b++){const I=P(le,O,b),M=le[`row${O}`]?.[b]||0;if(M>0)oe[`row${O}`][b]=I===2||I===3?M:0;else if(I===3){const C=B(le,O,b);C.player1>C.player2?oe[`row${O}`][b]=1:C.player2>C.player1?oe[`row${O}`][b]=2:oe[`row${O}`][b]=Math.random()>.5?1:2}else oe[`row${O}`][b]=0}}return oe},P=(le,oe,O)=>{let b=0;for(let I=-1;I<=1;I++)for(let M=-1;M<=1;M++){if(I===0&&M===0)continue;const C=oe+I,D=O+M;C>=0&&C<a&&D>=0&&D<a&&(le[`row${C}`]?.[D]||0)>0&&b++}return b},B=(le,oe,O)=>{let b=0,I=0;for(let M=-1;M<=1;M++)for(let C=-1;C<=1;C++){if(M===0&&C===0)continue;const D=oe+M,R=O+C;if(D>=0&&D<a&&R>=0&&R<a){const Me=le[`row${D}`]?.[R]||0;Me===1?b++:Me===2&&I++}}return{player1:b,player2:I}};it.useEffect(()=>{i.state==="fighting"&&!g&&d<10&&(v(!0),c(JSON.parse(JSON.stringify(i.grid))),m(0))},[i.state,g,i.grid]),it.useEffect(()=>{if(g&&l&&d<1e3){const le=setTimeout(()=>{const oe=w(l);c(oe),m(O=>O+1)},50);return()=>clearTimeout(le)}else g&&d>=1e3&&(v(!1),s&&s())},[g,l,d,s]);const K=e?i.user1?.uid===e.uid?1:i.user2?.uid===e.uid?2:0:0,me=(le,oe)=>{K===0||!(K===1&&le<Co||K===2&&le>=a-Co)||t(le,oe)},he=(le,oe)=>{const b=(g&&l?l:i.grid)[`row${le}`];return b&&b[oe]||0},ce=i.state==="waiting"||i.state==="started",be=()=>{const le=[];for(let oe=0;oe<a;oe++){const O=[];for(let b=0;b<a;b++){const I=he(oe,b),M=ce&&(K===1&&oe<Co||K===2&&oe>=a-Co);let C="#fff";I===1?C="#ffcccc":I===2?C="#ccccff":M?C=K===1?"#fff5f5":"#f5f5ff":C="#f9f9f9",O.push(X.jsx("div",{className:"grid-cell",onMouseEnter:()=>{T&&me(oe,b)},onClick:()=>{me(oe,b)},style:{width:"20px",height:"20px",border:"1px solid #ccc",display:"flex",alignItems:"center",justifyContent:"center",cursor:M?"pointer":"not-allowed",fontSize:"12px",backgroundColor:C},children:I!==0?I:""},`${oe}-${b}`))}le.push(X.jsx("div",{className:"grid-row",style:{display:"flex"},children:O},oe))}return le};return X.jsxs("div",{className:"game-canvas",children:[X.jsxs("div",{className:"player-info",style:{marginBottom:"10px"},children:[X.jsxs("p",{children:["You are Player ",K]}),ce&&X.jsxs(X.Fragment,{children:[X.jsxs("p",{children:["You can edit rows"," ",K===1?`0-${Co-1}`:`${a-Co}-${a-1}`]}),X.jsx("p",{children:"Click cells in your area to place your number"})]}),g&&X.jsxs("div",{className:"animation-status",children:[X.jsx("p",{children:X.jsx("strong",{children:"Conway's Game of Life Simulation"})}),X.jsxs("p",{children:["Generation: ",d," / 1000"]}),X.jsx("div",{className:"progress-bar",style:{width:"200px",height:"10px",backgroundColor:"#ddd",borderRadius:"5px",overflow:"hidden"},children:X.jsx("div",{className:"progress-fill",style:{width:`${d/1e3*100}%`,height:"100%",backgroundColor:"#4CAF50",transition:"width 0.1s ease"}})})]}),i.state==="fighting"&&!g&&i.winner&&X.jsxs("div",{className:"winner-announcement",children:[X.jsx("h3",{children:"🏆 Battle Complete! 🏆"}),i.winner==="tie"?X.jsxs("div",{children:[X.jsx("p",{children:X.jsx("strong",{children:"It's a tie!"})}),X.jsx("p",{children:"Both players have equal cell counts."}),X.jsxs("p",{children:["🤝 Great game, ",i.user1?.username," and"," ",i.user2?.username,"! 🤝"]})]}):X.jsxs("div",{children:[X.jsx("p",{children:X.jsxs("strong",{children:["Player"," ",i.winner==="player1"?"1":"2"," ","wins!"]})}),i.winner==="player1"&&i.user1&&X.jsxs("p",{children:["🎉 Congratulations ",i.user1.username,"! 🎉"]}),i.winner==="player2"&&i.user2&&X.jsxs("p",{children:["🎉 Congratulations ",i.user2.username,"! 🎉"]}),X.jsx("p",{children:"🏆 Victory achieved through superior strategy! 🏆"})]})]}),i.state==="fighting"&&!g&&!i.winner&&X.jsxs("div",{className:"winner-announcement",children:[X.jsx("h3",{children:"⚔️ Battle Processing... ⚔️"}),X.jsx("p",{children:"Server is calculating the final results..."})]})]}),X.jsx("div",{className:"grid-container",style:{display:"inline-block",border:"2px solid #333"},children:be()})]})},RV=yd(gc,"createGame"),IV=yd(gc,"joinGame");yd(gc,"startFightingPhase");const CV=yd(gc,"scheduleGameTransition"),NV=async(i,e)=>{try{return(await RV({userId:i,username:e})).data}catch(t){throw console.error("Error calling createGame function:",t),t}},DV=async(i,e,t)=>{try{return(await IV({gameId:i,userId:e,username:t})).data}catch(s){throw console.error("Error calling joinGame function:",s),s}},OV=async i=>{try{return(await CV({gameId:i})).data}catch(e){throw console.error("Error calling scheduleGameTransition function:",e),e}},MV=()=>{const[i,e]=it.useState(null),[t,s]=it.useState(""),[a,l]=it.useState(!1),[c,d]=it.useState(null),[m,g]=it.useState(!1),[v,T]=it.useState(!1),[w,P]=it.useState(!0),[B,Z]=it.useState(0),[K,me]=it.useState(!1);it.useEffect(()=>$u.onAuthStateChanged(async D=>{d(D),D&&await he(D.uid),P(!1)}),[]);const he=async C=>{try{const D=bk(sr,"games"),R=hS(D,Qh("user1.uid","==",C),Qh("state","!=","ended")),Me=hS(D,Qh("user2.uid","==",C),Qh("state","!=","ended")),[Ne,H]=await Promise.all([pS(R),pS(Me)]);if(Ne.empty){if(!H.empty){const te=H.docs[0];s(te.id),e({id:te.id,...te.data()})}}else{const te=Ne.docs[0];s(te.id),e({id:te.id,...te.data()})}}catch(D){console.error("Error checking for existing game:",D)}},ce=async()=>{if(c){l(!0);try{const C=await Ff(c.uid);if(!C){alert("Username not found. Please set up your username first."),l(!1);return}const D=await NV(c.uid,C);D.success?(s(D.gameId),T(!0)):alert("Failed to create game. Please try again.")}catch(C){console.error("Error creating game:",C),alert("Failed to create game. Please try again.")}finally{l(!1)}}},be=async C=>{if(c)try{const D=await Ff(c.uid);if(!D){alert("Username not found. Please set up your username first.");return}(await DV(C,c.uid,D)).success&&s(C)}catch(D){console.error("Error joining game:",D),alert("Failed to join game. Please check the game ID and try again.")}},le=async()=>{if(!t||!c||!i)return;const C=pa(sr,"games",t),R=i.user1?.uid===c.uid?"user1.ready":"user2.ready";try{await Tu(C,{[R]:!m})}catch(Me){console.error("Error updating ready state:",Me)}},oe=async()=>{if(!t||!c)return;const C=pa(sr,"games",t);try{await Tu(C,{state:"ended"}),e(null),s(""),g(!1),T(!1)}catch(D){console.error("Error aborting game:",D)}},O=async()=>{if(!t||!c)return;const C=pa(sr,"games",t);try{await Tu(C,{state:"waiting","user1.ready":!1,"user2.ready":!1,grid:b(50),startedAt:null,fightingStartedAt:null,finalGrid:null,winner:null,timerStarted:!1}),g(!1),me(!1),Z(0)}catch(D){console.error("Error restarting game:",D)}},b=C=>{const D={};for(let R=0;R<C;R++)D[`row${R}`]=Array(C).fill(0);return D},I=async(C,D)=>{if(!t||!c||!i)return;const R=i.user1?.uid===c.uid?1:i.user2?.uid===c.uid?2:0;if(R===0)return;const Me=pa(sr,"games",t);try{const Ne={...i.grid};Ne[`row${C}`]||(Ne[`row${C}`]=Array(50).fill(0));const H=Ne[`row${C}`][D]||0;Ne[`row${C}`][D]=H===0?R:0,await Tu(Me,{grid:Ne})}catch(Ne){console.error("Error updating grid:",Ne)}},M=()=>{me(!0)};if(it.useEffect(()=>{if(i?.state==="started"&&i.startedAt){const C=i.startedAt.toDate?i.startedAt.toDate():new Date(i.startedAt),D=new Date(C.getTime()+2*60*1e3),R=setInterval(()=>{const Me=new Date,Ne=Math.max(0,Math.ceil((D.getTime()-Me.getTime())/1e3));Z(Ne),Ne===0&&(clearInterval(R),console.log("Client-side timer reached zero - waiting for server to transition game"))},1e3);return()=>clearInterval(R)}},[i?.state,i?.startedAt]),it.useEffect(()=>{if(!t)return;const C=pa(sr,"games",t);return qk(C,R=>{if(R.exists()){const Me={id:R.id,...R.data()};if(Me.state==="ended"){e(null),s(""),g(!1),T(!1);return}if(e(Me),c){const H=Me.user1?.uid===c.uid?Me.user1?.ready:Me.user2?.ready;g(H||!1)}Me.user1?.ready&&Me.user2?.ready&&Me.state==="waiting"&&(async()=>{await Tu(C,{state:"started",startedAt:new Date,timerStarted:!1});try{await OV(t),console.log("Server-side timer started successfully")}catch(H){console.error("Error starting server-side timer:",H)}})()}})},[t,c]),i?.state==="started"){const C=Math.floor(B/60),D=B%60;return X.jsxs("div",{className:"game-started",children:[X.jsx("h2",{children:"Game Started!"}),X.jsxs("div",{className:"game-info",children:[X.jsxs("p",{children:["Players: ",i.user1?.username," vs"," ",i.user2?.username]}),X.jsxs("div",{className:"countdown-timer",children:[X.jsxs("h3",{children:["⏰ Time Remaining: ",C,":",D.toString().padStart(2,"0")]}),X.jsx("p",{children:"Prepare your strategy! The battle begins automatically when the timer reaches zero."})]}),X.jsx("div",{className:"game-controls",children:X.jsx("button",{onClick:oe,className:"abort-button",children:"Abort Game"})})]}),X.jsx(LS,{game:i,currentUser:c,onCellClick:I,gridSize:50})]})}return i?.state==="fighting"?X.jsxs("div",{className:"game-fighting",children:[X.jsx("h2",{children:"⚔️ Battle in Progress! ⚔️"}),X.jsxs("div",{className:"game-info",children:[X.jsxs("p",{children:["Players: ",i.user1?.username," vs"," ",i.user2?.username]}),X.jsxs("div",{className:"game-controls",children:[K&&X.jsx("button",{onClick:O,className:"restart-button",children:"🔄 Restart Game"}),X.jsx("button",{onClick:oe,className:"abort-button",children:"Abort Game"})]})]}),X.jsx(LS,{game:i,currentUser:c,onCellClick:I,onAnimationComplete:M,gridSize:50})]}):X.jsxs("div",{className:"creating-game",children:[w?X.jsx("div",{className:"loading",children:X.jsx("h2",{children:"Loading..."})}):X.jsxs(X.Fragment,{children:[X.jsx("h2",{children:"Create or Join Game"}),t?X.jsxs("div",{className:"game-lobby",children:[X.jsx("h3",{children:"Game Lobby"}),X.jsxs("p",{children:[X.jsx("strong",{children:"Game ID:"})," ",t]}),X.jsxs("div",{className:"players-section",children:[X.jsx("h4",{children:"Players:"}),X.jsxs("div",{className:"player-list",children:[X.jsxs("div",{className:"player",children:[X.jsx("span",{children:i?.user1?.username||"Player 1"}),X.jsx("span",{className:`ready-status ${i?.user1?.ready?"ready":"not-ready"}`,children:i?.user1?.ready?"✓ Ready":"○ Not Ready"})]}),X.jsxs("div",{className:"player",children:[X.jsx("span",{children:i?.user2?.username||"Waiting for Player 2..."}),i?.user2&&X.jsx("span",{className:`ready-status ${i?.user2?.ready?"ready":"not-ready"}`,children:i?.user2?.ready?"✓ Ready":"○ Not Ready"})]})]})]}),i?.user2&&X.jsxs("div",{className:"ready-section",children:[X.jsx("button",{onClick:le,className:`ready-button ${m?"ready":"not-ready"}`,children:m?"Cancel Ready":"Ready to Start"}),i?.user1?.ready&&i?.user2?.ready&&X.jsx("p",{className:"starting-message",children:"Starting game..."})]}),v&&!i?.user2&&X.jsxs("div",{className:"waiting-section",children:[X.jsx("p",{children:"Waiting for another player to join..."}),X.jsxs("p",{children:["Share this Game ID with your friend:"," ",X.jsx("strong",{children:t})]})]}),X.jsx("div",{className:"game-controls",children:X.jsx("button",{onClick:oe,className:"abort-button",children:"Abort Game"})})]}):X.jsxs("div",{className:"game-setup",children:[X.jsxs("div",{className:"create-game-section",children:[X.jsx("h3",{children:"Create New Game"}),X.jsx("button",{onClick:ce,disabled:a||!c,className:"create-button",children:a?"Creating...":"Create Game"})]}),X.jsxs("div",{className:"join-game-section",children:[X.jsx("h3",{children:"Join Existing Game"}),X.jsx("input",{type:"text",placeholder:"Enter Game ID",className:"game-id-input",onKeyDown:C=>{if(C.key==="Enter"){const D=C.target.value.trim();D&&be(D)}}}),X.jsx("button",{onClick:()=>{const D=document.querySelector(".game-id-input")?.value.trim();D&&be(D)},disabled:!c,className:"join-button",children:"Join Game"})]})]})]}),X.jsx("style",{children:`
            ...
            `})]})};function kV(){const[i,e]=it.useState(null),[t,s]=it.useState(null),[a,l]=it.useState(!0);it.useEffect(()=>{const d=hP($u,async m=>{if(e(m),m){const g=await Ff(m.uid);s(g)}else s(null);l(!1)});return()=>d()},[]);const c=async d=>{const m=await Ff(d);s(m)};return a?X.jsx("div",{children:"Loading..."}):X.jsx("div",{children:i?X.jsxs("div",{children:[X.jsxs("div",{children:["Welcome, ",t||i.email,"!"]}),X.jsx("button",{onClick:()=>$u.signOut(),children:"Logout"}),X.jsx(MV,{})]}):X.jsx(bV,{onAuthSuccess:c})})}i1.createRoot(document.getElementById("root")).render(X.jsx(it.StrictMode,{children:X.jsx(kV,{})}));
